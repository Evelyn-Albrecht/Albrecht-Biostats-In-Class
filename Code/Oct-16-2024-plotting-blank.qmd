...
4.  Now plot some data
    ...
    make a histogram first because it shows the distribution of one variable

    when making the histograms, start detecting outliers

```{r}
ggplot(rabies, aes(Received_Year)) + 
  geom_histogram()
ggplot(rabies, aes(Number_of_Samples)) + 
  geom_histogram()
ggplot(rabies, aes(Animal_classification)) + 
  geom_histogram() #encountered error. historgrams like continuous data
ggplot(rabies, aes(Animal_classification)) + 
